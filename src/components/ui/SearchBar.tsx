...
// Hero : recherche large (nom / langue / région) + bouton filtre -> panneau qui glisse.
    ...
    <>
      <div className="flex select-none items-center gap-1 rounded-full border border-stone/60 bg-surface/95 p-1.5 shadow-[var(--shadow-soft)] backdrop-blur">
        ...
        <button
          ...
          className={cn(
            "inline-flex h-12 shrink-0 items-center gap-2 rounded-full px-3 text-sm font-medium transition-colors sm:px-4",
        ...
        <Button size="lg" onClick={submit} className="h-12 shrink-0 rounded-full px-5 sm:px-6">
